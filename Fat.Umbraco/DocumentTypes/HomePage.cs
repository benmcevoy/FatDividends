...
namespace Fat.Umbraco.DocumentTypes
{
    ...
    [DocumentType(AllowedChildNodeTypes = new[] { typeof(ContentPage), typeof(SearchPage), typeof(StockDetail) }, DefaultTemplate = typeof(masterpages.Home), IconUrl = "settingDomain.gif")]
